...
var initApp = (function (app) {
  ...
  app.windowScrollEvents = function () {
    if (
      myapp_config.root_.is('.nav-function-hidden.header-function-fixed:not(.nav-function-top)') &&
      myapp_config.thisDevice === 'desktop'
    ) {
      ...
      myapp_config.root_.is('.header-function-fixed:not(.nav-function-top):not(.nav-function-hidden)') &&
      myapp_config.thisDevice === 'desktop'
    ) {
  ...
  app.domReadyMisc = function () {
    ...
    if (window.Waves && myapp_config.rippleEffect) {
      Waves.attach('.nav-menu:not(.js-waves-off) a, .btn:not(.js-waves-off):not(.btn-switch), .js-waves-on', [
        'waves-themed',
      ])
      Waves.init()
    ...
    // if (myapp_config.debugState)
    //   console.log(
    //     '%c✔ Finished app.init() v' + myapp_config.VERSION + '\n' + '---------------------------',
    //     'color: #148f32',
    //   )
  }
